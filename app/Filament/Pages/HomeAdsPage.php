...
class HomeAdsPage extends Page implements HasForms, HasTable
{
    use InteractsWithForms, InteractsWithTable;

    protected static ?string $navigationIcon = 'heroicon-o-home';
    protected static ?string $navigationLabel = 'إعلانات الرئيسية';
    protected static ?string $navigationGroup = 'إعدادات الإعلانات';
    protected static ?int $navigationSort = 102;
    protected static string $view = 'filament.pages.ads-page';
    protected static ?string $title = 'إعلانات الصفحة الرئيسية';
    protected static ?string $slug = 'home-ads';

    public function table(Table $table): Table
    {
        return $table
            ->query(AdSlot::query()->where('page_type', 'home')->orderBy('sort_order'))
            ->columns([
            ...
            ->heading('🏠 أماكن الإعلانات في الصفحة الرئيسية')
            ->description('تحكم في الإعلانات التي تظهر في الصفحة الرئيسية للموقع');
    }
}
