...
class CountryAdsPage extends Page implements HasForms, HasTable
{
    use InteractsWithForms, InteractsWithTable;

    protected static ?string $navigationIcon = 'heroicon-o-globe-alt';
    protected static ?string $navigationLabel = 'إعلانات صفحات الدول';
    protected static ?string $navigationGroup = 'إعدادات الإعلانات';
    protected static ?int $navigationSort = 103;
    protected static string $view = 'filament.pages.ads-page';
    protected static ?string $title = 'إعلانات صفحات الدول';
    protected static ?string $slug = 'country-ads';

    public function table(Table $table): Table
    {
        return $table
            ->query(AdSlot::query()->where('page_type', 'country')->orderBy('sort_order'))
            ->columns([
            ...
            ->heading('🌍 أماكن الإعلانات في صفحات الدول')
            ->description('تحكم في الإعلانات التي تظهر في صفحات الدول (مصر، العراق، ليبيا، إلخ)');
    }
}
