        ...
        <div class="bg-gradient-to-br from-white to-emerald-50 rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-8 md:p-10 border border-emerald-100">
            ...
            <div class="text-center mb-6 sm:mb-8 no-print">
                ...
                <h1 class="text-xl sm:text-2xl md:text-3xl font-black text-gray-800 mb-2 sm:mb-3 leading-relaxed text-center px-2">
                    نتيجة الدبلومات الفنية في <?php echo e($egypt->getDynamicTitle(false, false)); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.result-timer','data' => ['country' => 'egypt','type' => 'diplomas']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['country' => 'egypt','type' => 'diplomas']); ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($serviceType === 'search'): ?>
                ...
                <div class="mb-6 no-print">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" 
                                    @click="selectBranch(<?php echo e($branch->id); ?>, '<?php echo e($branch->code); ?>')"
                                ...
                                <i class="fa-solid <?php echo e($branch->icon ?? 'fa-graduation-cap'); ?> text-2xl sm:text-3xl mb-2 text-emerald-500"></i>
                                <span class="text-sm font-bold text-gray-800"><?php echo e(str_replace(['الدبلوم ', 'دبلوم '], '', $branch->name_ar)); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($branch->total_score): ?>
                                    <span class="text-xs text-gray-500 mt-1"><?php echo e($branch->total_score); ?> درجة</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                ...
                <form @submit.prevent="search" class="space-y-4 sm:space-y-6 no-print">
                    <div class="flex flex-col sm:flex-row gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($showYearFilter) && $showYearFilter && isset($academicYears) && $academicYears->count()): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pdfPath): ?>
                    <div class="text-center mb-6">
                        ...
                        <div class="flex items-center justify-center gap-4">
                            ...
                            <a href="<?php echo e(asset('uploads/' . $pdfPath)); ?>" target="_blank"
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                        <iframe src="<?php echo e(asset('uploads/' . $pdfPath)); ?>#toolbar=1&navpanes=1" 
            ...
            <?php elseif($serviceType === 'embed'): ?>
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($embedCode): ?>
                    <div class="text-center mb-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_starts_with($embedCode, 'http')): ?>
                            <iframe src="<?php echo e($embedCode); ?>" class="w-full border-0" style="min-height: 80vh;"></iframe>
                        <?php else: ?>
                            <?php echo $embedCode; ?>
...
function searchDiplomas() {
    return {
        ...
        academicYearId: '<?php echo e(\App\Models\AcademicYear::where("is_active", true)->value("id") ?? ""); ?>',
        loading: false,
        results: [],
        error: '',
        ...
        async search() {
            ...
            try {
                const response = await fetch('<?php echo e(route("search")); ?>', {
                    ...
                    body: JSON.stringify({
                        query: this.query,
                        exam_type_id: '<?php echo e($diplomaExamType ? $diplomaExamType?->id : ""); ?>',
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($diplomaExamType) && $diplomaExamType?->show_content_section && ($diplomaExamType?->content_title || $diplomaExamType?->content_body)): ?>
<div class="w-full max-w-6xl mx-auto mt-12 px-3">
    <div class="bg-white rounded-2xl shadow-lg p-6 md:p-10 border border-gray-100">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($diplomaExamType?->content_title): ?>
        <h2 class="text-xl md:text-2xl lg:text-3xl font-black text-gray-800 mb-5 pb-3 border-b-2 border-gray-100"><?php echo e($diplomaExamType?->content_title); ?></h2>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($diplomaExamType?->content_intro): ?>
        <p class="text-gray-600 mb-6 text-base md:text-lg leading-relaxed"><?php echo e($diplomaExamType?->content_intro); ?></p>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($diplomaExamType?->content_body): ?>
        <div class="prose prose-base md:prose-lg max-w-none text-gray-700 leading-loose
            ...
            <?php echo $diplomaExamType?->content_body; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Masry/GitHub/ntegty/resources/views/egypt/diplomas.blade.php ENDPATH**/ ?>