...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 py-12">
    <div class="container mx-auto px-4 max-w-4xl">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-sm text-gray-500 mt-2">آخر تحديث: <?php echo e(date('Y/m/d')); ?></p>
        </div>
            ...
            <div class="prose prose-lg max-w-none">
                ...
                <div class="mb-8">
                    ...
                    <div class="bg-purple-50 rounded-xl p-6">
                        <h3 class="font-bold text-lg text-gray-800 mb-3">3. ملفات تعريف الارتباط (Cookies)</h3>
                        <p class="text-gray-700">
                            نستخدم ملفات تعريف الارتباط لتحسين تجربتك على الموقع، وتذكر تفضيلاتك، وتحليل استخدام الموقع.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl p-8 text-center">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="inline-block bg-white text-blue-600 font-bold px-8 py-3 rounded-full hover:bg-gray-100 transition-all">
                        صفحة اتصل بنا
                    </a>
                </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ntegty/public_html/resources/views/privacy.blade.php ENDPATH**/ ?>