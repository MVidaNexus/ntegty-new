...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-gray-100">
                            <?php echo e(\App\Models\UploadLog::where('status', 'completed')->count()); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-gray-100">
                            <?php echo e(\App\Models\ExamType::where('result_service_type', 'pdf')->count()); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-gray-100">
                            <?php echo e(\App\Models\ExamType::where('result_service_type', 'embed')->count()); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-gray-100">
                            <?php echo e(\App\Models\ExamType::where('result_service_type', 'governorate_table')->count()); ?>
...
<?php endif; ?>
<?php /**PATH /Users/Masry/GitHub/ntegty/resources/views/filament/pages/upload-result-unified.blade.php ENDPATH**/ ?>