        ...
        async search() {
            ...
            try {
                const response = await fetch('<?php echo e(route("search")); ?>', {
                    ...
                    body: JSON.stringify({
                        query: this.query,
                        exam_type_id: '<?php echo e($diplomaExamType->id); ?>',
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ntegty/public_html/resources/views/egypt/diplomas.blade.php ENDPATH**/ ?>