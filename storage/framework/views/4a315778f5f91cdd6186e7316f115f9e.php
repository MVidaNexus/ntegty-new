...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="max-w-5xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <!-- Technical Diplomas -->
        <a href="<?php echo e(route('egypt.diplomas.index')); ?>" class="group block bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border-2 border-transparent hover:border-emerald-400">
        ...
        <!-- Azhar Secondary -->
        <a href="<?php echo e(route('egypt.azhar.secondary')); ?>" 
        ...
        <!-- Azhar Preparatory -->
        <a href="<?php echo e(route('egypt.azhar.preparatory')); ?>" 
           class="group block bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border-2 border-transparent hover:border-amber-400">
        ...
        <!-- Azhar Primary -->
        <a href="<?php echo e(route('egypt.azhar.primary')); ?>" 
           class="group block bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border-2 border-transparent hover:border-amber-400">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 md:p-10 border border-gray-100">
            ...
            <div class="prose prose-base md:prose-lg max-w-none text-gray-700 leading-loose
                ...
                <div class="text-lg md:text-xl font-medium text-gray-600 mb-6 leading-relaxed">
                    <?php echo $country->content_intro; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Masry/GitHub/ntegty/resources/views/egypt/index.blade.php ENDPATH**/ ?>