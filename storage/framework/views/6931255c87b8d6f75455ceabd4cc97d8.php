            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-xl border border-slate-200">
                ...
                <div class="mt-6 pt-6 border-t border-slate-200">
                    <p class="text-sm text-slate-500 flex items-center justify-center gap-2">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="text-blue-600 font-semibold hover:underline">التواصل معنا</a>
                    </p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Masry/GitHub/ntegty/resources/views/errors/404.blade.php ENDPATH**/ ?>